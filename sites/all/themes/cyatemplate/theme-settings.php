...
function cyatemplate_form_system_theme_settings_alter(&$form, $form_state) {
  $form['cyatemplate_mission'] = array(
    '#type' => 'textfield',
    '#title' => t('Mission statement'),
    '#default_value' => theme_get_setting('cyatemplate_mission'),
    '#size' => 128,
