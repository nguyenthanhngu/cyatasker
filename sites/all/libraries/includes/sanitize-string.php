 ...
 * via the plugin API. If $string is empty and $fallback_title is set, the latter
 * will be used.
 *
 * @since 1.0.0
 *
...
function sanitize_string( $string ) {
    ...
    $string = sanitize_string_with_dashes($string);
    return $string;
}
 ...
 */
function sanitize_string_with_dashes( $title ) {
...
function remove_accents( $string ) {
    ...
    if (seems_utf8($string)) {
        ...
        global $language;
        $locale = !empty($language) ? $language->language : 'en';
