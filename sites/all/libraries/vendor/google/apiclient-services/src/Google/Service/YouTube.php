...
<<<<<<< HEAD
 * <a href="https://developers.google.com/node_visibility/v3" target="_blank">Documentation</a>
=======
...
class Google_Service_YouTube extends Google_Service
{
  ...
  const YOUTUBE =
<<<<<<< HEAD
      "https://www.googleapis.com/auth/node_visibility";
  /** Manage your YouTube account. */
  const YOUTUBE_FORCE_SSL =
      "https://www.googleapis.com/auth/node_visibility.force-ssl";
  /** View your YouTube account. */
  const YOUTUBE_READONLY =
      "https://www.googleapis.com/auth/node_visibility.readonly";
  /** Manage your YouTube videos. */
  const YOUTUBE_UPLOAD =
      "https://www.googleapis.com/auth/node_visibility.upload";
=======
...
<<<<<<< HEAD
    $this->servicePath = 'node_visibility/v3/';
    $this->version = 'v3';
    $this->serviceName = 'node_visibility';
=======
